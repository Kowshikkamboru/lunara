      ...
      >
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          <div 
            ...
            role="button"
            tabIndex={0}
            onKeyDown={(e) => e.key === 'Enter' && handleScrollTo('hero')}
          >
          ...
          <nav className="hidden md:flex items-center gap-8 text-[11px] uppercase tracking-[0.2em] text-neutral-400 font-medium">
            ...
            <button onClick={() => handleScrollTo('evidence')} className="hover:text-brand-cyan transition-colors cursor-pointer">Research</button>
          </nav>
        ...
        {mobileMenuOpen && (
          ...
          >
            <nav className="flex flex-col gap-6 text-2xl font-display mt-8">
              ...
              <button onClick={() => handleScrollTo('evidence')} className="text-left text-white hover:text-brand-cyan transition-colors border-b border-white/5 pb-4">Research & Evidence</button>
              <button onClick={() => handleScrollTo('access')} className="text-left text-brand-cyan hover:text-white transition-colors pt-2">Request Early Access</button>
            </nav>
